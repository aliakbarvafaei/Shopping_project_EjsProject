...
app.get("/pages/:pageid", function ( req , res){
  ...
  if(req.params.pageid==1 || (10*(req.params.pageid-2)>=posts.length)){
    statePre="disabled";
  }
  if(10*parseInt(req.params.pageid)>=posts.length){
    stateNext="disabled";
  }
  setTimeout(()=>{
    res.render("frame" , {postsinf: posts , indexProduct: req.params.pageid, statePre: statePre, stateNext: stateNext});
  }, 0);
});
